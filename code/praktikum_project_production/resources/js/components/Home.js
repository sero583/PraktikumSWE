    ...
    return (
        <div className='home'>
            <div className='innerHome'>
                ...
                {coursesData?.courses ? (coursesData.courses.length>0 ? <CourseList courses={coursesData.courses}/> : <p>Nothing here yet. Visit your first course for it to appear here.</p>) : <div className='courses'>Loading...</div>}
                <h1>All courses</h1>
